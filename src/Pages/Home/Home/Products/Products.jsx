        ...
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                ...
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    <figure><img className='w-3/4' src={product1} alt="Shoes" /></figure>
                ...
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    <figure><img className='w-3/4' src={product2} alt="Shoes" /></figure>
                    <div className="card-body">
                        <h2 className="card-title font-bold text-center ">Car Engine Plug</h2>
                        <Rating
                        name="read-only"></Rating>
                ...
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    <figure><img className='w-3/4' src={product3} alt="Shoes" /></figure>
                    <div className="card-body">
                        <h2 className="card-title font-bold text-center ">Car Engine Plug</h2>
                        <Rating
                        name="read-only"></Rating>
